...
кілька ручних кроків (скачати експорти, поставити Ollama/Obsidian, апрувнути).

## Що отримуєте

- 📦 Lossless MD-архів усіх ваших чатів (1 розмова = 1 файл, читається в Obsidian)
- 🔎 Семантичний пошук по СЕНСУ (локальний, $0, приватний: Ollama + bge-m3 + sqlite-vec)
...
macOS або Linux · Python ≥ 3.11 · [Ollama](https://ollama.com) (модель bge-m3, ≈1.1 ГБ)
· [Obsidian](https://obsidian.md) · Claude Code. Хмарних залежностей нема; ключ
OpenRouter — лише опційний фолбек.
