...
> Раніше цей проєкт називався **Second Brain Kit**. Це та сама система під новою назвою — Кремнієва Січ (Silicon Sich).
...
| | По-простому | Що дає |
|---|---|---|
| **v1** *(безкоштовна, [публічне репо](https://github.com/steptonite/silicon-sich))* | база старту | твої архіви стають базою, яку агент читає й шукає по змісту |
