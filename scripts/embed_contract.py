...
Чому це окремий файл, а не рядок у config.toml (Льоша, 22.08.2026):

Катя поставила кит, не піднявши Ollama і не налаштувавши OpenRouter одразу. Далі
все поїхало наосліп: агент казав «локально, $0», гроші списувались, а спитати
було ніде — конфіг мовчазний, у ньому просто стоїть дефолт, і не видно, чи це
